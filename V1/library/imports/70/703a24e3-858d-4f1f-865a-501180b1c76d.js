"use strict";
cc._RF.push(module, '703a2TjhY1PH4ZaUBGAscdt', 'tool');
// scripts/lib/tool.ts

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.testingRotate = exports.hasScreenFringe = exports.offHide = exports.onHide = exports.offShow = exports.onShow = exports.screenFringe = exports.luanchOptions = exports.setAutoRecursively = exports.uploadFile = exports.shareAppMessage = exports.loadImg = exports.dateFrom = exports.url = void 0;
var state_1 = require("../../scripts/utils/state");
// import axios from '../utils/axiosUtils';
/**
 * 工具类
 */
exports.url = state_1.default.OSS_BASE;
/**
 *  格式化日期
 ...
 */
var urlBase = {
    avatar: state_1.default.OSS_BASE + '/avatar/',
};
function loadImg(url, callback, type, urlParams, imgType) {
    ...
    // console.log(url);
    cc.loader.load(url, function (_error, texture) {
 ...
 * 获取启动时的参数
 */
exports.luanchOptions = (function () {
    var shareOption = {
        title: '玩休闲游戏，赢优惠券，一起来玩~~',
        imageUrl: state_1.default.OSS_BASE + '/H5Game/share/main.png',
    };
    var options;
    if (cc.sys.platform === cc.sys.WECHAT_GAME) {
        ...
        wx.onShareAppMessage(function () { return shareOption; });
    }
    return {
        /**
         * 分享参数
         ...
         * 设置分享参数
         */
        setShareOption: function (option) { return shareOption = option; },
    };
})();
/**
 * 如果为刘海屏则进行适配
...
var hasScreenFringe = function () {
    var systemInfo = cc.sys.platform === cc.sys.WECHAT_GAME ? wx.getSystemInfoSync() : { model: null };
