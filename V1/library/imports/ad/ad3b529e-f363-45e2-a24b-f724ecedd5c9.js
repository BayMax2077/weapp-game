"use strict";
cc._RF.push(module, 'ad3b5Ke82NF4qJL9yTs7dXJ', 'asocket.io');
// scripts/lib/asocket.ioLib/asocket.io.js
...
module.exports = function (t) {
  ...
  t.exports = require("socket.io-parser");
}, function (t, e, n) {
  function o(t, e) {
  ...
  var i = n(12),
      ...
      p = n(5),
      h = n(6),
      a = n(0)("socket.io-client:manager"),
      u = n(15),
      f = n(16),
  ...
  t.exports = o, o.prototype.emitAll = function () {
    ...
    if (a("readyState %s", this.readyState), ~this.readyState.indexOf("open")) return this;
    a("opening %s", this.uri), this.engine = i(this.uri, this.opts);
    var n = this.engine,
        o = this;
    this.readyState = "opening", this.skipReconnect = !1;
    var s = p(n, "open", function () {
      o.onopen(), t && t();
    }),
        c = p(n, "error", function (e) {
      if (a("connect_error"), o.cleanup(), o.readyState = "closed", o.emitAll("connect_error", e), t) {
    ...
    if (!1 !== this._timeout) {
      var r = this._timeout;
      a("connect attempt will timeout after %d", r);
      var h = setTimeout(function () {
        a("connect attempt timed out after %d", r), s.destroy(), n.close(), n.emit("error", "timeout"), o.emitAll("connect_timeout", r);
      }, r);
      this.subs.push({
    ...
    a("open"), this.cleanup(), this.readyState = "open", this.emit("open");
    var t = this.engine;
    ...
    a("error", t), this.emitAll("error", t);
  }, o.prototype.socket = function (t, e) {
    function n() {
      ~u(i.connecting, o) || i.connecting.push(o);
    }
    ...
    a("disconnect"), this.skipReconnect = !0, this.reconnecting = !1, "opening" === this.readyState && this.cleanup(), this.backoff.reset(), this.readyState = "closed", this.engine && this.engine.close();
  }, o.prototype.onclose = function (t) {
    a("onclose"), this.cleanup(), this.backoff.reset(), this.readyState = "closed", this.emit("close", t), this._reconnection && !this.skipReconnect && this.reconnect();
  }, o.prototype.reconnect = function () {
    if (this.reconnecting || this.skipReconnect) return this;
    var t = this;
    if (this.backoff.attempts >= this._reconnectionAttempts) a("reconnect failed"), this.backoff.reset(), this.emitAll("reconnect_failed"), this.reconnecting = !1;else {
      var e = this.backoff.duration();
      a("will wait %dms before reconnect attempt", e), this.reconnecting = !0;
      var n = setTimeout(function () {
        t.skipReconnect || (a("attempting reconnect"), t.emitAll("reconnect_attempt", t.backoff.attempts), t.emitAll("reconnecting", t.backoff.attempts), t.skipReconnect || t.open(function (e) {
          e ? (a("reconnect attempt error"), t.reconnecting = !1, t.reconnect(), t.emitAll("reconnect_error", e.data)) : (a("reconnect success"), t.onreconnect());
        }));
      }, e);
      this.subs.push({
        destroy: function destroy() {
  ...
  s(o.prototype), o.prototype.subEvents = function () {
    if (!this.subs) {
      var t = this.io;
      this.subs = [r(t, "open", p(this, "onopen")), r(t, "packet", p(this, "onpacket")), r(t, "close", p(this, "onclose"))];
    }
    ...
    return n.options = {}, n.options.compress = !this.flags || !1 !== this.flags.compress, "function" == typeof e[e.length - 1] && (h("emitting packet with ack id %d", this.ids), this.acks[this.ids] = e.pop(), n.id = this.ids++), this.connected ? this.packet(n) : this.sendBuffer.push(n), delete this.flags, this;
  }, o.prototype.packet = function (t) {
    t.nsp = this.nsp, this.io.packet(t);
  }, o.prototype.onopen = function () {
    if (h("transport is open - connecting"), "/" !== this.nsp) if (this.query) {
      var t = "object" == typeof this.query ? a.encode(this.query) : this.query;
      h("sending connect packet with query %s", t), this.packet({
        type: i.CONNECT,
        query: t
      });
    } else this.packet({
  ...
  t.exports = require("component-emitter");
}, function (t, e) {
  ...
  t.exports = require("component-bind");
}, function (t, e, n) {
  t.exports = n(8);
}, function (t, e, n) {
  function o(t, e) {
    ...
    var n,
        ...
        a = o.path,
        u = p[h] && a in p[h].nsps;
    return e.forceNew || e["force new connection"] || !1 === e.multiplex || u ? (r("ignoring socket cache for %s", s), n = c(s, e)) : (p[h] || (r("new io instance for %s", s), p[h] = c(s, e)), n = p[h]), o.query && !e.query && (e.query = o.query), n.socket(o.path, e);
  }

  var i = n(9),
      s = n(1),
      c = n(2),
      r = n(0)("socket.io-client");
  t.exports = e = o;
  var p = e.managers = {};
  e.protocol = s.protocol, e.connect = o, e.Manager = n(2), e.Socket = n(3);
}, function (t, e, n) {
  (function (e) {
    var o = n(11),
        i = n(0)("socket.io-client:url");

    t.exports = function (t, n) {
      var s = t;
      n = n || e.location, null == t && (t = n.protocol + "//" + n.host), "string" == typeof t && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? n.protocol + t : n.host + t), /^(https?|wss?):\/\//.test(t) || (i("protocol-less url %s", t), t = void 0 !== n ? n.protocol + "//" + t : "https://" + t), i("parse %s", t), s = o(t)), s.port || (/^(http|ws)$/.test(s.protocol) ? s.port = "80" : /^(http|ws)s$/.test(s.protocol) && (s.port = "443")), s.path = s.path || "/";
      var c = -1 !== s.host.indexOf(":") ? "[" + s.host + "]" : s.host;
      return s.id = s.protocol + "://" + c + ":" + s.port, s.href = s.protocol + "://" + c + (n && n.port === s.port ? "" : ":" + s.port), s;
    };
  }).call(e, n(10));
}, function (t, e) {
  var n;
  ...
  t.exports = require("parseuri");
}, function (t, e) {
  t.exports = require("engine.io-client");
}, function (t, e) {
  t.exports = require("to-array");
}, function (t, e) {
  t.exports = require("parseqs");
}, function (t, e) {
  t.exports = require("indexof");
}, function (t, e) {
  t.exports = require("backo2");
}]);
